               ...
               <div className="bg-white rounded-[2rem] p-4 shadow-[0_12px_40px_rgb(0,0,0,0.06)] hover:shadow-[0_12px_40px_rgb(0,0,0,0.1)] transition-all flex flex-col border border-gray-50">
                 ...
                 <div className="px-2 flex-grow flex flex-col">
                   ...
                   <div className="mt-auto flex items-center justify-between">
                     ...
                     <Link href="/rooms/ground-floor-rooms" className="text-gray-600 font-semibold text-sm border border-gray-200 px-5 py-2.5 rounded-full hover:bg-gray-50 transition-colors">
                       View Details
                     </Link>
                   </div>
                 </div>
               ...
               <div className="bg-white rounded-[2rem] p-4 shadow-[0_12px_40px_rgb(0,0,0,0.06)] hover:shadow-[0_12px_40px_rgb(0,0,0,0.1)] transition-all flex flex-col border border-gray-50">
                 ...
                 <div className="px-2 flex-grow flex flex-col">
                   ...
                   <div className="mt-auto flex items-center justify-between">
                     ...
                     <Link href="/rooms/group-rooms" className="text-gray-600 font-semibold text-sm border border-gray-200 px-5 py-2.5 rounded-full hover:bg-gray-50 transition-colors">
                       View Details
                     </Link>
                   </div>
                 </div>
               ...
               <div className="bg-white rounded-[2rem] p-4 shadow-[0_12px_40px_rgb(0,0,0,0.06)] hover:shadow-[0_12px_40px_rgb(0,0,0,0.1)] transition-all flex flex-col border border-gray-50">
                 ...
                 <div className="px-2 flex-grow flex flex-col">
                   ...
                   <div className="mt-auto flex items-center justify-between">
                     ...
                     <Link href="/rooms/couple-rooms" className="text-gray-600 font-semibold text-sm border border-gray-200 px-5 py-2.5 rounded-full hover:bg-gray-50 transition-colors">
                       View Details
                     </Link>
                   </div>
                 </div>
