...
export default function CombinedManage() {
  ...
  return (
    <div className="px-4 sm:px-9 py-1 min-h-screen" style={{ backgroundColor: 'var(--color-blue-whites)' }}>
      ...
      <div className="relative flex items-center mb-6 border-b border-[#4D8CF5]/20 overflow-x-auto no-scrollbar">
        <div className="relative flex w-full min-w-[500px] sm:min-w-full">
          {/* Sliding background */}
          <div
