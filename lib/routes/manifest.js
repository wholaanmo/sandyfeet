...
export const ROUTE_MANIFEST = [
  ...
  // ─── Privileged Write API Routes (Task 4.4) ─────────────────────────────────
  { id: 'api-reservations-create', kind: 'api', pattern: '/api/reservations/create', methods: ['POST'], audience: 'guest', status: 'active', landingForRole: null, redirectTo: null, csrf: true, rateLimitPolicy: 'guest-write', sensitiveResponse: true },
  { id: 'api-reservations-edit', kind: 'api', pattern: '/api/reservations/[id]/edit', methods: ['POST'], audience: 'guest', status: 'active', landingForRole: null, redirectTo: null, csrf: true, rateLimitPolicy: 'guest-write', sensitiveResponse: true },
  { id: 'api-reservations-cancel', kind: 'api', pattern: '/api/reservations/[id]/cancel', methods: ['POST'], audience: 'guest', status: 'active', landingForRole: null, redirectTo: null, csrf: true, rateLimitPolicy: 'guest-write', sensitiveResponse: true },
  { id: 'api-payments-transition', kind: 'api', pattern: '/api/payments/[id]/transition', methods: ['POST'], audience: 'staff-or-admin', status: 'active', landingForRole: null, redirectTo: null, csrf: true, rateLimitPolicy: 'admin-write', sensitiveResponse: true },
  { id: 'api-payments-refund', kind: 'api', pattern: '/api/payments/[id]/refund', methods: ['POST'], audience: 'admin', status: 'active', landingForRole: null, redirectTo: null, csrf: true, rateLimitPolicy: 'admin-write', sensitiveResponse: true },
  { id: 'api-guest-profile', kind: 'api', pattern: '/api/guest/profile', methods: ['GET', 'PATCH'], audience: 'guest', status: 'active', landingForRole: null, redirectTo: null, csrf: true, rateLimitPolicy: null, sensitiveResponse: true },
];
