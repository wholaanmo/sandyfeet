...
// lib/staffEmailService.js - updated getBaseUrl function
const getBaseUrl = () => {
  // On server-side, we must use environment variable
  ...
  const emailContent = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f0f9ff; border-radius: 16px;">
      ...
      <div style="background-color: white; border-radius: 12px; padding: 20px; margin-bottom: 20px;">
        ...
        <p style="color: #0B3B4F; font-size: 16px;">Your account has been created for the Sandy Feet Resort management system.</p>
