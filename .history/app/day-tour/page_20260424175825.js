    ...
    <GuestLayout>
      <div className="min-h-screen bg-[#FAFAFA] pt-32 pb-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          {/* HEADER & BOOKING SECTION - Updated Layout */}
          <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-8">
            
            {/* Left side - Book Your Day Tour Text (aligned with Date Container) */}
            ...
            {/* Right side - Date Container with 50% width */}
            <div className="w-full lg:w-1/2">
              {dayTour ? (
                /* Date Container when day tour is available */
                <div className="bg-white rounded-[2rem] shadow-[0_15px_40px_rgba(0,0,0,0.04)] border border-ocean-light/20 overflow-hidden">
                  {/* Date picker and guest inputs */}
                  <div className="p-4 sm:p-6">
                    ...
                    {dateError && <p className="text-[11px] leading-tight text-rose-500/80 pl-1 mt-3">{dateError}</p>}
                  </div>

                  {/* Price Display and Proceed Button - Positioned at lower right */}
                  <div className="flex items-center justify-end gap-4 p-4 sm:p-6 pt-0">
                  ...
                  {/* Description and Inclusions inside Date Container */}
                  {dayTour && (
                    <>
                      {dayTour.description && (
                        <div className="mt-4 p-5 bg-gradient-to-br from-ocean-ice/40 to-white rounded-2xl border border-ocean-light/20 mx-4 sm:mx-6 mb-4">
                      ...
                      {dayTour.inclusions && dayTour.inclusions.length > 0 && (
                        <div className="mb-4 p-5 bg-gradient-to-br from-amber-50/40 to-white rounded-2xl border border-amber-200/30 mx-4 sm:mx-6">
                ...
                /* UNIFIED MESSAGE - Day Tour is not available (single container) */
                <div className="bg-white rounded-[2rem] shadow-[0_15px_40px_rgba(0,0,0,0.04)] border border-ocean-light/20 p-8 text-center">
                  <div className="flex flex-col items-center gap-3">
                    <div className="w-14 h-14 rounded-full bg-red-50 flex items-center justify-center">
                      <i className="fas fa-calendar-times text-red-500 text-2xl"></i>
                    </div>
                    <p className="text-red-600 font-medium text-base">Day Tour is not available.</p>
                  </div>
                </div>
              )}
            </div>
