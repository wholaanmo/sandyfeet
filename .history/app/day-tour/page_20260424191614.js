...
export default function DayTourPage() {
  ...
  // Fetch day tour - REMOVED archive filter to get all tours including archived
  useEffect(() => {
    const toursRef = collection(db, 'dayTours');
    const toursQuery = query(toursRef); // Removed where('archived', '==', false) to include archived tours
      ...
      <div className="min-h-screen bg-[#FAFAFA] pt-32 pb-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="flex flex-col lg:flex-row lg:items-start justify-between bg-white p-8 sm:p-10 rounded-[2.5rem] shadow-[0_15px_40px_rgba(0,0,0,0.04)] border border-ocean-light/20 gap-8">
            ...
            {/* Right side - Select Date Container (hide when archived OR availability is 'unavailable') */}
