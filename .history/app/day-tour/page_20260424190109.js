        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="flex flex-col lg:flex-row lg:items-start justify-between bg-white p-8 sm:p-10 rounded-[2.5rem] shadow-[0_15px_40px_rgba(0,0,0,0.04)] border border-ocean-light/20 gap-8">
            ...
            <div className="w-full lg:w-1/2">
              {dayTour && dayTour.availability === 'unavailable' ? (
                /* When day tour exists but is marked unavailable - show message with matching height */
                <div className="bg-red-50/50 p-6 rounded-[2rem] border border-red-200/50 text-center min-h-[280px] flex items-center justify-center">
                ...
                /* When no day tour exists in database (archived or never created) - show message */
                <div className="bg-red-50/50 p-6 sm:p-8 rounded-[2rem] border border-red-200/50 text-center min-h-[280px] flex items-center justify-center">
                  <div className="flex flex-col items-center gap-3">
                    <div className="w-14 h-14 rounded-full bg-red-100 flex items-center justify-center">
                      <i className="fas fa-calendar-times text-red-500 text-2xl"></i>
                    </div>
