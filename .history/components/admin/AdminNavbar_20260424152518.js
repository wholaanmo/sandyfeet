...
const getNotificationStyle = (type) => {
  ...
  <>
    ...
    <p className="text-xs text-gray-600 mb-1">
      <span className="font-semibold">{notification.guestName}</span> | Booking ID: <span className="font-mono">{notification.bookingId}</span> is scheduled to check in
    </p>
  ...
  <>
    ...
    <p className="text-xs text-gray-600 mb-1">
      <span className="font-semibold">{notification.guestName}</span> | Booking ID: <span className="font-mono">{notification.bookingId}</span> is scheduled to check out
    </p>
