    ...
    >
      <div className="flex items-center justify-between h-full px-6 w-full">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 px-2 py-2 rounded-full bg-gradient-to-r from-[#4D8CF5]/5 to-[#7AAAF8]/5 backdrop-blur-sm shadow-sm border border-[#4D8CF5]/15 hover:shadow-md hover:border-[#4D8CF5]/30 transition-all duration-300">
