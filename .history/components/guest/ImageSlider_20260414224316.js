...
export default function ImageSlider({ images, roomType }) {
  ...
  return (
    <div className="relative">
      {/* Main Image Container — fixed aspect ratio instead of fixed px height */}
      <div
        className={`relative overflow-hidden rounded-lg bg-gray-100 ${isZoomed ? 'cursor-zoom-out' : 'cursor-zoom-in'}`}
      ...
      >
        ...
        {/* Image Counter */}
        <div className="absolute bottom-3 right-3 bg-black/50 text-white px-2.5 py-0.5 rounded-full text-xs backdrop-blur-sm z-10">
