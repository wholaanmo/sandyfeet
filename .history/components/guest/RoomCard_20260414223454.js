...
export default function RoomCard({ room }) {
  ...
  return (
    <>
      ...
      {/* Details Modal with Image Slider - Modern & Clean Design with Reduced Size */}
      {showDetailsModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={() => setShowDetailsModal(false)}>
          <div className="bg-white rounded-2xl w-full max-w-2xl max-h-[80vh] overflow-auto shadow-2xl animate-in zoom-in-95 duration-200" onClick={(e) => e.stopPropagation()}>
            {/* Modal Header - Clean & Minimal with reduced padding */}
            ...
            {/* Modal Content - Optimized padding for better spacing */}
            <div className="px-5 py-4">
              {/* Image Gallery with Slider - Improved Layout with consistent aspect ratio */}
              {room.images && room.images.length > 0 && (
                <div className="mb-5">
              ...
              {/* Room Details Grid - Modern spacing with compact design */}
              ...
              {/* Inclusions Section - Compact spacing */}
              <div className="mb-4">
              ...
              {/* Description Section - Compact design */}
              <div className="mb-4">
            ...
            {/* Modal Footer - Clean actions with reduced padding */}
            <div className="sticky bottom-0 bg-white/95 backdrop-blur-sm border-t border-gray-100 px-5 py-3 flex gap-2 justify-end">
              <button
                onClick={() => setShowDetailsModal(false)}
